...
# TradingView 차트 삽입 - 1분봉 기준
st.subheader("📈 실시간 GOLD 차트 (1분봉 기준)")
st.components.v1.iframe(
    "https://kr.tradingview.com/widgetembed/?frameElementId=tradingview_gold_1m&symbol=TVC:GOLD&interval=1&hidesidetoolbar=1&symboledit=1&saveimage=1&toolbarbg=f1f3f6&studies=BollingerBands%40tv-basicstudies,MACD%40tv-basicstudies,RSI%40tv-basicstudies&theme=dark&style=1&timezone=Asia%2FSeoul",
    height=500,
    width=1000,
)
